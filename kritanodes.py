...
from .imagewebsocket import SendImageWebSocket
...
class WorkflowExchange:
    ...
    async def _notify(self, client_id: str, publisher: Publisher):
        ...
        await self._server.send_json("JAX_workflow_published", data, client_id)
